...
$button.Add_Click({
        ...
        if ($github) {
            ...
            $pbo = Get-ChildItem -Path C:\ -Filter PBOTuner -Recurse -ErrorAction SilentlyContinue -Force | select-object -first 1 | ForEach-Object { $_.FullName; }
            ...
            $exePath = Get-ChildItem -Path C:\ -Filter 'PBO2 Tuner.exe' -Recurse -ErrorAction SilentlyContinue -Force | select-object -first 1 | ForEach-Object { $_.FullName; }
